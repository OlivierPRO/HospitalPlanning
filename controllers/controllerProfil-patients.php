...
$profilFind = $patients->getProfilId();
...
$appointmentsInPatient = new appointments();
$appointmentsInPatient->idPatients = $_GET['idPatient'];
$showAppointmentsList = $appointmentsInPatient->showAppointmentInProfilPatient(); 
